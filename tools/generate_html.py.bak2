...
<body>
    ...
    <div class="page-container">
        ...
        <div class="left-col">
            ...
            <div class="symbology-box">
                <div class="symbology-title">SIMBOLOGÍA</div>
                <div class="symbology-item"><div class="symb-color" style="background: #a0522d;"></div> Comunidades del corredor</div>
                <div class="symbology-item"><div class="symb-color" style="background: #f5b7b1; border-color: transparent;"></div> Posibles comunidades a integrar</div>
                <div class="symbology-item"><div class="symb-color kba-pattern" style="border-color: #f39c12;"></div> Ecu 52 kba</div>
                <div class="symbology-item"><div class="symb-color" style="background: #1e8449;"></div> Ecu_25</div>
                <div class="symbology-item"><div class="symb-color" style="background: transparent; border: 3px dashed #e74c3c;"></div> Corredor NorOriental</div>
                <div class="symbology-item"><div class="symb-color" style="background: #fff; border: 1px solid #000;"></div> Napo</div>
                <div class="symbology-item"><div class="symb-color" style="background: #a9dfbf;"></div> SNAP</div>
            </div>
...
html_template += """
  ...
  "22": { "lat": -0.06, "lng": 0.115, "size": 320, "ix": 0, "iy": 0, "iz": 125 },
